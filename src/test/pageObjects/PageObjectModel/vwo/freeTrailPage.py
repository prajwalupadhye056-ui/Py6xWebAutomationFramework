...
class freeTrailPage:
    ...
    error_msg_invalid_email=(By.XPATH,"//input[@id='page-756cu-gdpr-consent-checkbox']")
...
def get_checkbox_terms(self):
    return self.driver.find_element(*freeTrailPage.checkbox_terms)

def get_error_msg_invalid_email(self):
    return self.driver.find_element(*freeTrailPage.error_msg_invalid_email)
